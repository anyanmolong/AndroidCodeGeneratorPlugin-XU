    ...
    public Configurable[] getConfigurables() {
        if (configurables == null) {
            configurables = new Configurable[]{
                    ...
                    new TemplateConfigurable("Activity xutils Template", "Setup Template for Activity xutils code generation:", "Activity_xu_template"),
                    ...
                    new TemplateConfigurable("Fragment xutils Template", "Setup Template for Fragment code generation:", "Fragment_xu_template"),
